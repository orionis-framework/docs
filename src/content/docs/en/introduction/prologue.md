...
Orionis Framework delivers unmatched performance and efficiency in Python. Built on Granian, the fastest HTTP server in the Python ecosystem, developed in Rust. Enjoy exceptional efficiency and speed, leveraging the best of both languages.

### Supported Interfaces

- **A** ASGI: Full compatibility with ASGI interfaces, integrating Orionis with major frameworks and modern Python tools.
...
- **100k+** Requests per second  
    Granian + Orionis on modern hardware
